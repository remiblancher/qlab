...
echo -e "Command:"
echo -e "  ${CYAN}pki ca init --name \"Classic Code Signing CA\" --profile ec/root-ca --dir $CLASSIC_CA${NC}"
echo ""
...
echo -e "Command:"
echo -e "  ${CYAN}pki ca init --name \"PQC Code Signing CA\" --profile ml-dsa/root-ca --dir $PQC_CA${NC}"
echo ""
